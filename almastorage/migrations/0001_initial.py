...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('sw_container', (
            ...
            ('service_slug', self.gf('django.db.models.fields.CharField')(unique=True, max_length=30)),
    ...
    models = {
        ...
        u'almastorage.swiftcontainer': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'service_slug': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '30'}),
